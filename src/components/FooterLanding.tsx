    ...
    <div className='w-full bg-[#FFFF] py-24'>
      <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
        ...
        <div className='col-span-2'>
          ...
          <h3 className='py-2 text-[#6D737A]'>Rue des Sables <br></br>1000 Brussels,Belgium.</h3>
          <h3 className='py-2 text-[#363A3D]'>Email: example@mail.com</h3>
          <div className='flex gap-4 py-4'>
            <div className='p-4 bg-[#ecdebc] rounded-xl'><FaInstagram size={25} style={{ color: '#d4B184' }} /></div>
          </div>
        </div>
        ...
        <div className='max-[780px]:col-span-2'>
          ...
          <h3 className='py-2 text-[#6D737A]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br></br> vestibulum gravida in, feugiat auctor felis.</h3>
          <form className='py-4'>
            <input
              className='bg-[#F2F3F4] p-4 w-full rounded-full'
              placeholder='Email here'
            />
            <button className='max-[780px]:w-full my-4 px-5 py-3 rounded-full bg-beige2 text-white font-medium'>Subscribe Now</button>
          </form>
        </div>
