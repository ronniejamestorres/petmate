    ...
    <div className="flex justify-center ">
      <div className="bg-purewhite text-black text-center text-sm rounded-lg border border-beige2 p-8  m-10 lg:text-md lg:p-2 lg:m-4">
        <p>
          ...
          {data?.characteristics.animal} - <span>{data?.characteristics.age} years old</span>
          - <span>{data?.characteristics.race}</span>- <span>{data?.characteristics.weight} kg</span>
        </p>
        <p>
        ...
        <p>
          ...
          <div className="flex flex-wrap justify-center mt-4">
             {loading ? <h1>Loading</h1> :  data?.characteristics.favoriteFoods.map((food, index) => (
